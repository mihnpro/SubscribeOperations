...
type EmptyDateErrExample struct {
	Error string `json:"error" example:"start_date and end_date are required"`
}

type SubStartDateAfterEndDateExample struct {
	Error string `json:"error" example:"end_date cannot be before start_date"`
}
...
type EmptySubIDExample struct {
	Error string `json:"error" example:"Subscription ID is required"`
}
